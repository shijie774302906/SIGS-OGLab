...
check('发布分支', branch === 'release/process158-dual-production-deployment', `branch=${branch || 'detached'}`);
...
if (existsSync(distManifestPath)) {
  ...
  check('构建清单 Process', manifest.process === 'Process162', `process=${manifest.process}`);
