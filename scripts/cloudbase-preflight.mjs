...
if (fs.existsSync(distPath)) {
  ...
  check('构建清单指向国内正式站', releaseManifest?.process === 'Process161' && releaseManifest?.canonicalSite === 'https://sigs-oglabx.com', releaseManifest ? `${releaseManifest.process} / ${releaseManifest.canonicalSite}` : 'missing');
