const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.CidZOsoP.js","assets/chunks/framework.ZXCZ9mzl.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, c as createElementBlock, r as renderSlot, n as normalizeClass, o as openBlock, a as createTextVNode, t as toDisplayString, b as createBlock, w as withCtx, T as Transition, e as createCommentVNode, _ as _export_sfc, u as useData$1, i as isExternal, f as treatAsHtml, g as withBase, h as computed, j as createBaseVNode, k as unref, l as isActive, m as useMediaQuery, p as ref, q as watch, s as watchEffect, v as onMounted, x as onUnmounted, y as watchPostEffect, z as onUpdated, A as getScrollOffset, F as Fragment, B as renderList, C as resolveComponent, D as onContentUpdated, E as createVNode, G as shallowRef, H as resolveDynamicComponent, I as EXTERNAL_URL_RE, J as useRoute, K as mergeProps, L as inject, M as useWindowSize, N as normalizeStyle, O as onKeyStroke, P as nextTick, Q as useWindowScroll, R as inBrowser, S as readonly, U as defineAsyncComponent, V as __vitePreload, W as useScrollLock, X as provide, Y as toHandlers, Z as withKeys, $ as onBeforeUnmount, a0 as withModifiers, a1 as useSlots } from "./framework.ZXCZ9mzl.js";
...
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CidZOsoP.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const _hoisted_2 = { class: "doc-feedback-actions" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const pageUrl = computed(() => `https://sigs-oglabx.com/help/${page.value.relativePath.replace(/(^index|\/index)?\.md$/, "")}`);
    const mailHref = computed(() => {
      const subject = encodeURIComponent("SIGS-OGLab 手册反馈");
      const body = encodeURIComponent(`手册页面：${pageUrl.value}

请写下问题或建议：
`);
      return `mailto:sigsoglab@163.com?subject=${subject}&body=${body}`;
    });
    return (_ctx, _cache) => {
        ...
        "doc-after": withCtx(() => [
          createBaseVNode("section", _hoisted_1, [
            _cache[0] || (_cache[0] = createBaseVNode("div", null, [
              createBaseVNode("strong", { id: "doc-feedback-title" }, "页面和实际操作不一致？"),
              createBaseVNode("span", null, "请告诉我们具体页面和遇到的问题。")
            ], -1)),
            createBaseVNode("div", _hoisted_2, [
              createBaseVNode("a", { href: mailHref.value }, "提交问题", 8, _hoisted_3)
            ])
          ])
        ]),
        _: 1
